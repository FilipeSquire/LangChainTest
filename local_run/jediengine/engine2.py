...
class EngineJedi():
    ...
    def process_text_types(self,chunks):
        tables, texts, images= [], [], []
    ...
    def summarization(self, texts, tables):
    ...
    def vector_store_buildup(self, texts, tables, text_summaries, table_summaries):
    ...
    def fit(self):
        chunks = self.run_engine()
        tables, texts, images = self.process_text_types(chunks)
        text_summaries, table_summaries = self.summarization(texts, tables)        
        ...
        retriever = self.vector_store_buildup(texts, tables, text_summaries, table_summaries)
